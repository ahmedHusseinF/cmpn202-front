...
@NgModule({
  ...
  providers: [LoginService, ApiService, FlashMessagesService, ProfileService, dashBoardService, MerchantService,
    guestAccess, haveAccess, UpdateService, GlobalVariablesService
  ],
